<script src="<?=js_url()?>help.js"></script>
<link rel="stylesheet" type="text/css" href="<?=css_url()?>custom/help.css">
...
<div id='help_content'>
    <div class="sidebar">
        ...
        <a href="#add_channel_twitch">Adicionar Canal - Twitch</a>
        <a href="#add_channel_facebook">Adicionar Canal - Facebook</a>
    </div>
    ...
    <div class="container content">
        <div>
            ...
            <p>
                Nesta página você encontrará informações sobre a utilização da plataforma StreamDesk.
            </p>
        </div>
        ...
        <div id='add_channel_twitch'>
            ...
            <p>Após isto você irá entrar no menu de inserção de canal, aonde deverá informar o nome do canal e selecionar a plataforma Twitch.</P>
